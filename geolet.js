...
(function () {
	...
	var _defaultMarker = function (controlOptions) {
		...
		return L.marker(null, {
			icon: L.divIcon({
				html: '<svg width="20" height="20" viewport="0 0 20 20"><circle cx="10" cy="10" r="10" style="fill:#7FDEF0"/><circle cx="10" cy="10" r="7" style="fill:none;stroke:currentColor;stroke-width:2px"/><circle cx="10" cy="10" r="4" style="fill:#000000"/></svg>',
				iconAnchor: [10, 10],
				className: ''
			}),
